      ...
      <main className={styles.event__detail__container}>
        <div className={styles.event__detail__left}>
          <div className={styles.left__inner}>
            <div className={styles.start__date}>Oct 19</div>
            <h1 className={styles.event__title}>Advaya helping hands</h1>
            <div className={styles.organiser__info}>
              <div className={styles.organiser__name}>By Avadya Co.</div>
              <abbr title="email address">
                <span className={styles.email}>Email:</span>
                <a href="mailto: adarshshanbhag5@gmail.com">
                  adarshshanbhag5@gmail.com
                </a>
              </abbr>
              <abbr title="phone number">
                <span className={styles.phone}>Phone:</span>
                <a href="tel:+919845606575">7019712764</a>
              </abbr>
            </div>
          </div>
          ...
          <div className={styles.event__details}>
            ...
            <div className={styles.quill__content__container}></div>
          </div>
        </div>
